...
class TestPublicarReviewUseCase:
    ...
    def test_publica_review_validates_both_entities(self):
        ...
        # Arrange
        dto = ReviewDTO(comentario="Test", nota=5, id_aluno=1, id_materia=1)
...
class TestReviewEntity:
    ...
    def test_review_with_id(self):
        """Test Review with id"""
        review = Review(comentario="Good", nota=4, id_aluno=1, id_materia=1)
        review.id = 42
        assert review.id == 42

    def test_review_properties(self):
        """Test Review properties"""
        review = Review(comentario="Comment", nota=3, id_aluno=1, id_materia=1)
