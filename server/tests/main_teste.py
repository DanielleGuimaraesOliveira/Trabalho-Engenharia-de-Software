...
class TestRouteRegistration:
    ...
    def test_aluno_routes_function_called(self, mock_register):
        ...
        from src.app.main import app, cria_aluno_use_case, auth_aluno_use_case
    ...
    def test_review_routes_function_called(self, mock_register):
        ...
        from src.app.main import app, publica_review_use_case, lista_reviews_use_case
    ...
    def test_materia_routes_function_called(self, mock_register):
        ...
        from src.app.main import app, lista_materias_use_case
...
class TestRepositoryImports:
    ...
    def test_aluno_repository_imported(self):
        ...
        from src.infra.repositories.SQLAlchemyAlunoRepository import (
            SQLAlchemyAlunoRepositorio,
        )
