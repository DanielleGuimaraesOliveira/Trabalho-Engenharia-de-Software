...
class TestCriaAlunoUseCase:
    ...
    def setup_method(self):
        ...
        self.use_case = CriaAlunoUseCase(
            repositorio_aluno=self.mock_repository, senha_hash=self.mock_hash_service
        )
    ...
    def test_cria_aluno_with_valid_data(self):
        ...
        # Arrange
        dto = AlunoDTO(
            nome="João Silva", email="joao@aluno.puc-rio.br", senha="senha123"
        )
...
class TestAutenticaAlunoUseCase:
    ...
    def test_autentica_aluno_with_valid_credentials(self):
        ...
        aluno = Aluno(
            nome="João", email="joao@aluno.puc-rio.br", senhaHash="hashed_senha123"
        )
        aluno.id = 1
        ...
        self.mock_repository.encontra_por_email.assert_called_once_with(
            "joao@aluno.puc-rio.br"
        )
